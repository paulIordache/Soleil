    ...
    void ImageMemBarrier(VkCommandBuffer CmdBuf, VkImage Image, VkFormat Format,
        ...
        VkImageMemoryBarrier barrier = {
            ...
            .subresourceRange = VkImageSubresourceRange{
                ...
                .levelCount = 1,
                .baseArrayLayer = 0,
                .layerCount = static_cast<u32>(LayerCount)
            }
        };
        ...
        } // === NEW CASES FOR RAY TRACING SHADOW IMAGE ===

        // Convert from read-only to GENERAL (RT writes)
        ...
        // Convert from GENERAL to read-only (RT wrote -> raster reads)
        ...
        // --- CHANGE 'if' TO 'else if' HERE ---
            ...
            printf("Unknown barrier case %d %d\n", OldLayout, NewLayout);
            exit(1);
        }
